...
Il faut aussi installer l'extension pg_trgm : 
    ...
    postgres@at1:~$ psql -d template1 -c 'CREATE EXTENSION IF NOT EXISTS unaccent;' -U postgres
    postgres@at1:~$ psql -d template1 -c 'CREATE EXTENSION IF NOT EXISTS btree_gin;' -U postgres
