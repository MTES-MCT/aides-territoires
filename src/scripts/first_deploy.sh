...
PG_EXCLUDE_DATA="--exclude-table-data=stats_* --exclude-table-data=django_session"
pg_dump $PG_OPTIONS $PG_EXCLUDE_SCHEMA $PG_EXCLUDE_DATA --dbname $STAGING_DATABASE_URL --format c --file /tmp/dump.pgsql
