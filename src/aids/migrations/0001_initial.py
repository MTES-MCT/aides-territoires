    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('targeted_audiences', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(choices=[('commune', 'Commune'), ('department', 'Department'), ('region', 'Region'), ('epci', 'EPCI'), ('company', 'Company'), ('civil_society', 'Civil society'), ('association', 'Association'), ('other', 'Other')], max_length=32), blank=True, size=None, verbose_name='Targeted audiences')),
                ('targeted_audiences_detail', models.CharField(blank=True, max_length=256, verbose_name='Targeted audiences detail')),
