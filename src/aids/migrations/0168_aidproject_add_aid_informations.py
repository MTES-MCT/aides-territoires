...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='aidproject',
            name='aid_paid',
            field=models.BooleanField(default=False, help_text='Cette aide a-t-elle été reçue par le porteur du projet ?', verbose_name='Aide reçue ?'),
        ),
        migrations.AddField(
            model_name='aidproject',
            name='aid_requested',
        ...
        migrations.AddField(
            model_name='aidproject',
            name='date_paid',
            field=models.DateTimeField(blank=True, help_text='Date à laquelle cette aide a été reçue par le porteur du projet', null=True, verbose_name="Date de la réception de l'aide"),
        ),
        migrations.AddField(
            model_name='aidproject',
            name='date_requested',
