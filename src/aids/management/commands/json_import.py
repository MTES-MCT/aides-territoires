...
class Command(BaseCommand):
    ...
    def get_destinations(self, data):
        ...
        destinations = [DESTINATIONS[original_destination] for
                        original_destination in original_destinations]
        return destinations

    def get_thematics(self, data):
        original_thematics = data['thematiques']
        thematics = [THEMATICS[original_thematic] for original_thematic in original_thematics]
        return thematics
