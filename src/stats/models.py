...
class AidContactClickEvent(models.Model):
    ...
    querystring = models.TextField(_("Querystring"), default="")
...
class AidSearchEvent(models.Model):
    ...
    text = models.CharField(_("Text search"), max_length=256, blank=True, default="")
...
class Event(models.Model):
    ...
    meta = models.CharField(_("Name"), max_length=256, default="")
    source = models.CharField("Source", max_length=256, default="")
...
class PromotionDisplayEvent(models.Model):
    promotion = models.ForeignKey(
        "blog.PromotionPost", verbose_name=_("Promotion Post"), on_delete=models.PROTECT
    )
