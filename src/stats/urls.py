...
from stats.views import StatsView, DashboardView, UsersStatsView, ProjectsStatsView, OrganizationsStatsView
...
urlpatterns = [
    ...
    path('stats-structures/', OrganizationsStatsView.as_view(), name='organizations_stats'),
]
