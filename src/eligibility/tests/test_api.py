...
def test_api(client):
    ...
    eligibility_test_2.questions.add(eligibility_question_1, through_defaults={'order': 2})
    eligibility_test_2.questions.add(eligibility_question_2, through_defaults={'order': 1})
