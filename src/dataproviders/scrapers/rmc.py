...
class RMCSpider(scrapy.Spider):
    ...
    start_urls = [
        'https://www.eaurmc.fr/jcms/gbr_5503/fr/les-aides-financieres-primes-et-appels-a-projets?PortalAction_ppi_6464_start=0&PortalAction_ppi_6464_pageSize=12&PortalAction_ppi_6464_pagerAll=true&PortalAction_ppi_6464_sort=&PortalAction_ppi_6464_reverse=false',
    ]
