...
SIB_WELCOME_CONTRIBUTOR_EMAIL_TEMPLATE_ID = env.int('SIB_WELCOME_CONTRIBUTOR_EMAIL_TEMPLATE_ID')
SIB_WELCOME_BENEFICIARY_EMAIL_TEMPLATE_ID = env.int('SIB_WELCOME_BENEFICIARY_EMAIL_TEMPLATE_ID')
