...
SIB_WELCOME_CONTRIBUTOR_EMAIL_TEMPLATE_ID = env.int('SIB_WELCOME_CONTRIBUTOR_EMAIL_TEMPLATE_ID', 0)
SIB_WELCOME_BENEFICIARY_EMAIL_TEMPLATE_ID = env.int('SIB_WELCOME_BENEFICIARY_EMAIL_TEMPLATE_ID', 0)
...
# Imports
GRAND_EST_API_USERNAME = env('GRAND_EST_API_USERNAME', default='')
GRAND_EST_API_PASSWORD = env('GRAND_EST_API_PASSWORD', default='')
