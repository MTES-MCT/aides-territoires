...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=core.fields.ChoiceArrayField(base_field=models.CharField(choices=[('Collectivités', (('commune', 'Communes'), ('epci', 'EPCI à fiscalité propre'), ('department', 'Départements'), ('region', 'Régions'), ('special', "Collectivités d'outre-mer à statuts particuliers"))), ('Autres bénéficiaires', (('association', 'Associations'), ('private_person', 'Particuliers'), ('farmer', 'Agriculteurs'), ('private_sector', 'Entreprises privées'), ('public_cies', 'Entreprises publiques locales (Sem, Spl, SemOp)'), ('public_org', "Établissements publics (écoles, bibliothèques…) / Services de l'État"), ('researcher', 'Recherche')))], max_length=32), blank=True, null=True, size=None, verbose_name='Targeted audiences'),
        ),
    ]
