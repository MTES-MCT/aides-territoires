    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, default='', verbose_name='Full description of the backer')),
                ('is_suggested', models.BooleanField(default=False, help_text='If the project is suggested by an user', verbose_name='Is a suggested project?')),
