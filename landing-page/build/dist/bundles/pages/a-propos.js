...
// CONCATENATED MODULE: ./components/HeaderAPropos.js
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();
...
var HeaderAPropos_HeaderPorteurAide = function (_React$Component) {
...
/* harmony default export */ var HeaderAPropos = (HeaderAPropos_HeaderPorteurAide);
...
// CONCATENATED MODULE: ./pages/a-propos.js
var a_propos__createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }();

function a_propos__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function a_propos__possibleConstructorReturn(self, call) { if (!self) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return call && (typeof call === "object" || typeof call === "function") ? call : self; }

function a_propos__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function, not " + typeof superClass); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }
...
var a_propos_porteurAidePage = function (_React$Component) {
  a_propos__inherits(porteurAidePage, _React$Component);

  function porteurAidePage() {
    a_propos__classCallCheck(this, porteurAidePage);

    return a_propos__possibleConstructorReturn(this, (porteurAidePage.__proto__ || Object.getPrototypeOf(porteurAidePage)).apply(this, arguments));
  }

  a_propos__createClass(porteurAidePage, [{
    key: "render",
    value: function render() {
      return external__react__default.a.createElement(
        DefaultLayout["a" /* default */],
        null,
        external__react__default.a.createElement(HeaderAPropos, null)
      );
    }
  }]);
...
/* harmony default export */ var a_propos = __webpack_exports__["default"] = (a_propos_porteurAidePage);
