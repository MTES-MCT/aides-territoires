        ...
        <section className="section">
          <div className="columns">
            <div className="column">
              <h1 className="title is-3">A l’origine d’Aides-territoires </h1>
              <p>
                L’aventure Aides-territoires part d’un constat, partagé à tous
                les niveaux : l’accès aux aides publiques (financement,
            ...
            <div className="column">
              ...
              <p>
                Aides-territoires fonctionne grâce à une base d’aides dynamique
                et mise à jour régulièrement. Nous mettons en place des
                partenariats avec les porteurs d’aides pour faciliter la
                diffusion des aides et la mise à jour de notre base. Vous voulez
                faire partie de nos partenaires ? Contactez-nous ! Vous portez
                une aide en particulier ou vous connaissez une aide qui n’est
                pas référencée ? Référencez-la  Si les critères proposés dans ce
                formulaire ne correspondent pas à votre aide, contactez-nous,
                d’autres projets arrivent. Aides-territoires est partenaire et
                partage sa base de données avec le site initié par la Direction
                Régionale de l’Environnement de l’Aménagement et du Logement
                (DREAL) Nouvelle Aquitaine et qui propose un accès thématique
                aux aides financières disponibles pour les projets des
                territoires.
              </p>
            </div>
          </div>
        ...
        <section className="section">
          <div className="has-text-centered">
            ...
            <Link href="/porteurs-aides#referencez-vous">
              <a className="button is-medium is-primary">Référencer une aide</a>
            </Link>
          </div>
        </section>
        <section className="section">
